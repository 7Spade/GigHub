...
1. **Login:** https://supabase.com/dashboard/project/zecsbstjqjqoytwgjyct
2. **Navigate:** SQL Editor → New query
3. **Copy & Run:**
   - File: `supabase/migrations/20251212_04_task_quantity_expansion.sql`
   - Then: `supabase/migrations/20251212_05_task_quantity_rls_policies.sql`
...
# Or specific files
npx supabase db execute --file supabase/migrations/20251212_04_task_quantity_expansion.sql
npx supabase db execute --file supabase/migrations/20251212_05_task_quantity_rls_policies.sql
```
...
- Or use Supabase Dashboard SQL Editor (auto uses service role)
...
✅ **All checks pass:**
- [ ] 3 new tables visible in Supabase Dashboard
