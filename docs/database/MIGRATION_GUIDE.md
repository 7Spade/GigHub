...
This guide provides step-by-step instructions for applying the Task Quantity Expansion feature migrations to your Supabase database.

**Migration Files:**
- `supabase/migrations/20251212_04_task_quantity_expansion.sql` - Schema changes
- `supabase/migrations/20251212_05_task_quantity_rls_policies.sql` - Security policies

**Target Database:** https://zecsbstjqjqoytwgjyct.supabase.co
...
### Method 1: Supabase Dashboard (Recommended for Manual Application)
...
### Method 2: Supabase MCP (via GitHub Copilot)

**Prerequisites:**
- GitHub Copilot enabled
- Supabase MCP configured in `.github/copilot/mcp-servers.yml`
...
2. **Request Migration Execution**
   ```
   @workspace Execute the following SQL migrations using Supabase MCP:
   1. supabase/migrations/20251212_04_task_quantity_expansion.sql
   2. supabase/migrations/20251212_05_task_quantity_rls_policies.sql
...
2. **Execute Migrations**
   ...
   export DB_URL="postgresql://postgres:[YOUR-PASSWORD]@db.zecsbstjqjqoytwgjyct.supabase.co:5432/postgres"
   
   # Apply schema migration
   psql "$DB_URL" -f supabase/migrations/20251212_04_task_quantity_expansion.sql
   
   # Apply RLS policies
   psql "$DB_URL" -f supabase/migrations/20251212_05_task_quantity_rls_policies.sql
   ```
...
3. In Supabase Dashboard, use SQL Editor (automatically uses service role)
...
2. **Review Documentation**
   ...
   - Check Supabase docs for RLS troubleshooting
