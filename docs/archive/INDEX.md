...
- `BUILD_FIX_SUMMARY.md` - 建置修復總結
- `CDK_CLEANUP_SUMMARY.md` - CDK 清理總結
- `IMPLEMENTATION_SUMMARY.md` - 實作總結

**分類**:
- 驗證報告: Blueprint 解耦、Audit Logs 驗證
- 模組總結: Task、Construction Log、Climate、Notification
...
- `GigHub_Architecture_Analysis.md` - 架構分析
- `blueprint-designer-analysis-2025-12-11.md` - Blueprint Designer 分析
...
### 12. 📚 Development Guides（開發指南）- 2 個文件

開發最佳實踐和指南。

**文檔**:
- `DEVELOPMENT_BEST_PRACTICES.md`
- `SHARED_MODULES_GUIDE.md`
...
**文檔**:
- `BLUEPRINTS_LIST_UX_PROPOSAL.md`
- `NAVIGATION_SIMPLIFICATION_PROPOSAL.md`
- `SIMPLIFIED_BREADCRUMB_PROPOSAL.md`
...
**藍圖系統** (Blueprint):
- blueprint-analysis/ (33 個文件)
- 相關: summaries/ 中的驗證報告

**任務管理** (Task):
- implementation/ (4 個文件)
...
👉 `auth/firebase-authentication.md`
