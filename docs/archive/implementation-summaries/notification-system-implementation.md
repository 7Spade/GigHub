...
### 目標
- 將假資料替換為真實的 Supabase 資料
- 使用 Angular 20 Signals 進行狀態管理
- 實現即時通知功能（Supabase Realtime）
...
**檔案**: `supabase/migrations/20251212_04_create_notifications_table.sql`
...
2. **使用參數化查詢**
   - Repository 使用 Supabase client 自動處理
