...
本目錄包含 GitHub Copilot 集合配置檔案，用於組織相關的 agents、prompts、instructions 和 chatmodes。

## 如何使用 Collections

在 VS Code 的 Copilot Chat 中，Collections 可以幫助您快速組織和使用相關的 Copilot 資源。
...
| `project-planning.md` | 專案規劃 | 專案規劃與管理相關資源 |
