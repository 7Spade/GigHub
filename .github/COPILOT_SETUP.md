...
└── agents/                           # Custom agent definitions
    ...
    └── supabase.agent.md             # Supabase specialist
```
...
**When to use**:
- Working with Angular, ng-alain, ng-zorro-antd, Supabase
...
- **Dual Backend**: Using Firebase with Supabase
...
### supabase.agent.md
Supabase specialist agent for database design, RLS policies, and backend integration.
