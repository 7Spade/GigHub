...
- Connect to Supabase MCP server for database operations
...
**Purpose:** Provides Copilot with access to up-to-date documentation for Angular, ng-alain, ng-zorro-antd, Supabase, and other libraries  
...
**Purpose:** Identifies your Supabase project for MCP server connection  
**Usage:** Referenced in `.github/copilot/mcp-servers.yml`  
...
### 3. Supabase MCP Token

**Secret Name:** `SUPABASE_MCP_TOKEN`  
**Description:** Supabase MCP authentication token  
**Purpose:** Authenticates Copilot Coding Agent with Supabase MCP server  
**Usage:** Referenced in `.github/copilot/mcp-servers.yml`
...
**Problem:** Copilot cannot connect to Context7 or Supabase MCP servers.
