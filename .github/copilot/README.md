...
- **Project Overview**: Technology stack (Angular 20, ng-alain, ng-zorro-antd, Supabase)
...
- API call anti-patterns (component → Supabase direct calls)
...
- `/gighub-repository` - Generate Supabase repository
