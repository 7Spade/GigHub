...
describe('BlueprintContainer', () => {
  ...
  describe('Module Loading', () => {
    ...
    it('should throw error if loading before initialization', async () => {
      ...
      await expectAsync(
        uninitContainer.loadModule(module)
      ).toBeRejectedWithError(/must be initialized/);
    });
    ...
    it('should throw error if module already loaded', async () => {
      ...
      ).toBeRejectedWithError(/already loaded/);
    });
    ...
    it('should check dependencies before loading', async () => {
      ...
      await expectAsync(
        container.loadModule(module)
      ).toBeRejectedWithError(/Missing dependencies/);
    });
  ...
  describe('Module Unloading', () => {
    ...
    it('should throw error if module not found', async () => {
      await expectAsync(
        container.unloadModule('non-existent')
    ...
    it('should prevent unloading module with dependents', async () => {
      ...
      await expectAsync(
        container.unloadModule('base')
      ).toBeRejectedWithError(/has dependents/);
    });
  });
  ...
  describe('Container Start/Stop', () => {
    ...
    it('should throw error if starting before ready', async () => {
      ...
      await expectAsync(
        uninitContainer.start()
      ).toBeRejectedWithError(/must be ready/);
    });
    ...
    it('should throw error if stopping when not running', async () => {
      await expectAsync(
        container.stop()
      ).toBeRejectedWithError(/not running/);
    });
  ...
  describe('Hot Reload', () => {
    ...
    it('should throw error if module not found', async () => {
      await expectAsync(
        container.reloadModule('non-existent')
      ).toBeRejectedWithError(/not found/);
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle container start error with circular dependencies', async () => {
      ...
      await expectAsync(
        container.start()
      ).toBeRejectedWithError(/Circular dependencies/);
