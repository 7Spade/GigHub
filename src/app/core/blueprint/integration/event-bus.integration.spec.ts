...
describe('Event Bus Integration', () => {
  ...
  describe('Event History', () => {
    ...
    it('should include event metadata in history', async () => {
      ...
      context.eventBus.emit('CUSTOM_EVENT', { 
        data: 'test data',
        userId: '123'
      }, 'test-source');
  ...
  describe('Event Subscriptions', () => {
    it('should support multiple handlers for same event', async () => {
      ...
      context.eventBus.on('TEST_MULTI', (e) => { handler1Calls.push(e); });
      context.eventBus.on('TEST_MULTI', (e) => { handler2Calls.push(e); });
      context.eventBus.on('TEST_MULTI', (e) => { handler3Calls.push(e); });
